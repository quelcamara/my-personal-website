...
export default class Portfolio extends React.Component {
    render() {
        let posts = getPages(this.props.pages, '/portfolio');
                  ...
                  <div className="portfolio-feed">
                    {(posts_count > 0) && ((() => {
                        ...
                        return (
                          ...
                          <article key={post_idx} className="portfolio">
                            {_.get(post, 'frontmatter.thumb_img_path', null) && (
                            <Link className="portfolio-thumbnail" href={withPrefix(_.get(post, '__metadata.urlPath', null))}>
                              ...
                              <h2 className="portfolio-title"><Link href={withPrefix(_.get(post, '__metadata.urlPath', null))} rel="bookmark">{_.get(post, 'frontmatter.title', null)}</Link></h2>
